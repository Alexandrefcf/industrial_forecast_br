...
class MSSA(object):
    ...
    def embed(self, embedding_dimension=None): #embedding_dimension = L - embed é a matriz trajetória
        """
        ...
        self.K = self.ts_N - self.embedding_dimension + 1 # N-L-1 = K
    ...
    def K_reccurent_forecast(self, steps):
